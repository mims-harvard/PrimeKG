...
As discussed in [issue #9](https://github.com/mims-harvard/PrimeKG/issues/9) OMIM phenotypes and genes were not fully included in the original version of PrimeKG.
The code to expand PrimeKG with OMIM entries is available at `append_omim.ipynb`. 
This jupyter notebook is an example of how to append new data to PrimeKG, too.
