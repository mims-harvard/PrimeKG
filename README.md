...
We provide the scripts used to process all primary data resources and the names of the resulting output files generated by those scripts. The processed files used to create PrimeKG are available on request. 
